<?php /* Smarty version Smarty-3.0.7, created on 2011-10-23 15:16:24
...
?>&nbsp;&nbsp;&nbsp;&nbsp;<?php endfor; endif; ?><?php echo smarty_modifier_escape($_smarty_tpl->getVariable(\'category\')->value->name);?>
								...
								<?php Smarty_Internal_Function_Call_Handler::call (\'category_select\',$_smarty_tpl,array(\'categories\'=>$_smarty_tpl->getVariable(\'category\')->value->subcategories,\'selected_id\'=>$_smarty_tpl->getVariable(\'selected_id\')->value,\'level\'=>$_smarty_tpl->getVariable(\'level\')->value+1),\'2630927084ea40598b7d0d0_52011605\',false);?>
...
"/> 
		...
		<div class="checkbox">
			<input name=hit value="1" type="checkbox" id="hit_checkbox" <?php if ($_smarty_tpl->getVariable('product')->value->hit){?>checked<?php }?>/> <label for="hit_checkbox">Хит</label>
		</div>
	</div> 
...
?>
				<li>
					<select name="categories[]">
						<?php Smarty_Internal_Function_Call_Handler::call ('category_select',$_smarty_tpl,array('categories'=>$_smarty_tpl->getVariable('categories')->value,'selected_id'=>$_smarty_tpl->getVariable('product_category')->value->id),'2630927084ea40598b7d0d0_52011605',false);?>
...
<?php }?>" /><?php echo $_smarty_tpl->getVariable('settings')->value->units;?>
			...
			<li class="variant_download">
				...
				<div class=browse_attachment style='display:none;'>
					<input type=file name=attachment[<?php echo $_smarty_tpl->getVariable('variant')->value->id;?>
]>
				</div>
