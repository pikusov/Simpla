<?php /* Smarty version Smarty-3.0.7, created on 2011-10-22 16:41:06
...
?>&nbsp;&nbsp;&nbsp;&nbsp;<?php endfor; endif; ?><?php echo $_smarty_tpl->getVariable(\'category\')->value->name;?>
								...
								<?php Smarty_Internal_Function_Call_Handler::call (\'category_select\',$_smarty_tpl,array(\'categories\'=>$_smarty_tpl->getVariable(\'category\')->value->subcategories,\'selected_id\'=>$_smarty_tpl->getVariable(\'selected_id\')->value,\'level\'=>$_smarty_tpl->getVariable(\'level\')->value+1),\'2930962074ea2c7f2d222d9_27387784\',false);?>
		...
		<div class="block">
			<h2>Использовать в категориях</h2>
					<select class=multiple_categories multiple name="feature_categories[]">
						<?php Smarty_Internal_Function_Call_Handler::call ('category_select',$_smarty_tpl,array('categories'=>$_smarty_tpl->getVariable('categories')->value),'2930962074ea2c7f2d222d9_27387784',false);?>
