<?php /* Smarty version Smarty-3.0.7, created on 2011-10-21 20:08:11
...
$_smarty_tpl->decodeProperties(array (
  ...
  array (
    ...
    array (
      ...
      'compiled' => '<?php if (!is_callable(\'smarty_modifier_escape\')) include \'/Users/denispikusov/Sites/simpla/Smarty/libs/plugins/modifier.escape.php\';
?>
...
?>&nbsp;&nbsp;&nbsp;&nbsp;<?php endfor; endif; ?><?php echo smarty_modifier_escape($_smarty_tpl->getVariable(\'category\')->value->name);?>
						...
						<?php Smarty_Internal_Function_Call_Handler::call (\'category_select\',$_smarty_tpl,array(\'categories\'=>$_smarty_tpl->getVariable(\'category\')->value->subcategories,\'selected_id\'=>$_smarty_tpl->getVariable(\'selected_id\')->value,\'level\'=>$_smarty_tpl->getVariable(\'level\')->value+1),\'20193028614ea1a6fb58e955_17425927\',false);?>
...
\'><?php echo $_smarty_tpl->getVariable(\'c\')->value->name;?>
		...
		<?php Smarty_Internal_Function_Call_Handler::call (\'categories_tree\',$_smarty_tpl,array(\'categories\'=>$_smarty_tpl->getVariable(\'c\')->value->subcategories),\'20193028614ea1a6fb58e955_17425927\',false);?>
...
?>
<?php ob_start(); ?>
	<li class="active"><a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('module'=>'ProductsAdmin','keyword'=>null,'category_id'=>null,'page'=>null),$_smarty_tpl);?>
">Товары</a></li>
...
<?php }?>
<?php if ($_smarty_tpl->getVariable('products')->value||$_smarty_tpl->getVariable('keyword')->value){?>
<form method="get">
<div id="search">
...
"><?php echo smarty_modifier_truncate(smarty_modifier_escape($_smarty_tpl->getVariable('variant')->value->name),30,'…',true,true);?>
					...
					<input class="price" type="text" name="price[<?php echo $_smarty_tpl->getVariable('variant')->value->id;?>
...
"><?php echo $_smarty_tpl->getVariable('smarty')->value['section']['target_page']['index']+1;?>
			...
			<select name="target_category">
				<?php Smarty_Internal_Function_Call_Handler::call ('category_select',$_smarty_tpl,array('categories'=>$_smarty_tpl->getVariable('categories')->value),'20193028614ea1a6fb58e955_17425927',false);?>
...
<div id="right_menu">
	...
	<!-- Категории товаров -->
	<?php Smarty_Internal_Function_Call_Handler::call ('categories_tree',$_smarty_tpl,array('categories'=>$_smarty_tpl->getVariable('categories')->value),'20193028614ea1a6fb58e955_17425927',false);?>
